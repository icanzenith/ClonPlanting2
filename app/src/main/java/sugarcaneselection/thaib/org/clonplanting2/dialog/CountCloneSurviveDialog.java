 ...
 */
public class CountCloneSurviveDialog extends DialogFragment{
    ...
    public CountCloneSurviveDialog() {

    }

    public static DialogFragment newInstance() {
        DialogFragment d = new CountCloneSurviveDialog();
        return d;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvTitle.setText("นับจำนวนต้นที่รอด");
                ...
                query.findInBackground(new FindCallback<ParseObject>() {
                    ...
                    public void done(List<ParseObject> list, ParseException e) {
                        if (e==null){
                            ...
                            o.put(Columns.SurviveAmount,mAmount);
    ...
    private void onSaveToDatabase(int uploaded) {
        ...
        v.put(Columns.SurviveAmount,mAmount);
