...
import sugarcaneselection.thaib.org.clonplanting2.HomeMenu2Activity;
import sugarcaneselection.thaib.org.clonplanting2.HomeMenuActivity;
import sugarcaneselection.thaib.org.clonplanting2.LoginActivity;
...
public class SessionManager {
    ...
    public void checkLogin() {
        if (this.isLoggedIn()) {
            ...
            Intent i = new Intent(_context, HomeMenu2Activity.class);
//            Intent i = new Intent(_context, HomeMenuActivity.class);
    ...
    public void Logout(Activity activity) {
        ...
        SQLiteDatabase db = _context.openOrCreateDatabase(Database.AUTHORITY, Context.MODE_WORLD_WRITEABLE, null);

        /**
         * Drop Table
         * */
        db.execSQL(mySQLiteHelper.DROP_TABLE_CloneFromMe);
        db.execSQL(mySQLiteHelper.DROP_TABLE_CloneToMe);
        db.execSQL(mySQLiteHelper.DROP_TABLE_LAND);
        db.execSQL(mySQLiteHelper.DROP_TABLE_PLANTING);

        /**
         * Re Create Table
         * */
        db.execSQL(mySQLiteHelper.Create_Land);
        db.execSQL(mySQLiteHelper.Create_CloneToMe);
        db.execSQL(mySQLiteHelper.Create_CloneFromMe);
        db.execSQL(mySQLiteHelper.Create_TABLE_PLANTING);
